...
const bringImages = [
  { src: '/images/wellbeing-retreat/bring-1-energy.png', title: '恢復能量', desc: '在自然場域放慢步調，協助員工從高壓中回充。' },
  { src: '/images/wellbeing-retreat/bring-2-relax.png', title: '放鬆節奏', desc: '建立慢旅節奏，讓身心重新找回平衡。' },
  { src: '/images/wellbeing-retreat/bring-3-nature.png', title: '自然中的安定感', desc: '森林與自然環境帶來穩定與安定感。' },
  { src: '/images/wellbeing-retreat/bring-4-connection.png', title: '更自然的連結', desc: '脫離工作角色，建立更自然的團隊連結。' },
  { src: '/images/wellbeing-retreat/bring-5-comm.png', title: '更自在的交流', desc: '在輕鬆情境中，讓對話與交流更自在。' },
];

const leaveImages = [
  { src: '/images/wellbeing-retreat/leave-1-memory.png', title: '員工放鬆的回憶', desc: '留下員工真實放鬆與投入的回憶畫面。' },
  { src: '/images/wellbeing-retreat/leave-2-share-memory.png', title: '值得分享的回憶', desc: '形成可分享的活動回憶，強化雇主品牌。' },
  { src: '/images/wellbeing-retreat/leave-3-material.png', title: '可分享的活動素材', desc: '產出可內外使用的照片與活動素材包。' },
  { src: '/images/wellbeing-retreat/leave-4-culture.png', title: '企業文化溫度', desc: '呈現關懷員工、重視福祉的企業文化溫度。' },
  { src: '/images/wellbeing-retreat/leave-5-inspiration.png', title: '後續活動靈感', desc: '為下一次員工活動留下靈感與方向。' },
];
  ...
  return (
    <div>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 -mt-8">
        <img src="/images/wellbeing-retreat/hero.png" alt="員工身心平衡旅程 頁首大橫幅" className="w-full h-64 md:h-96 object-cover rounded-2xl shadow-xl" loading="lazy" />
      </div>
      ...
      <section className="py-16">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <h2 className="text-3xl font-bold text-ftg-forest mb-8 text-center">一段好的身心平衡旅程，可以帶來什麼？</h2>
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 mb-16">
            {bringImages.map((p, i) => <PhotoCard key={i} {...p} />)}
          </div>

          <h2 className="text-3xl font-bold text-ftg-forest mb-8 text-center">旅程可以留下什麼？</h2>
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 mb-12">
            {leaveImages.map((p, i) => <PhotoCard key={i} {...p} />)}
          </div>
