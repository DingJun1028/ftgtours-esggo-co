...
const noteImages = [
  { src: '/images/esg-impact-note/note-1-esg-actions.png', title: 'ESG 行動亮點', desc: '把活動中的環境、社會行動轉譯為可回報的 ESG 亮點。' },
  { src: '/images/esg-impact-note/note-2-feedback.png', title: '參與者回饋與感受', desc: '整理員工真實回饋，成為雇主品牌與福祉溝通素材。' },
  { src: '/images/esg-impact-note/note-3-local-env.png', title: '地方及環境貢獻', desc: '呈現活動對地方共益與環境友善的具體貢獻。' },
  { src: '/images/esg-impact-note/note-4-overview.png', title: '旅程與活動全貌', desc: '以一頁全貌圖重現活動脈絡，便於內部與外部溝通。' },
];

const resultImages = [
  { src: '/images/esg-impact-note/result-1-social-value.png', title: '地方共好與社會價值', desc: '彙整地方共益、社會價值等可量化成果。' },
  { src: '/images/esg-impact-note/result-2-sdgs.png', title: 'ESG／SDGs 對應整理', desc: '將活動對應至 SDGs 與企業 ESG 目標。' },
  { src: '/images/esg-impact-note/result-3-participation.png', title: '參與人次與投入紀錄', desc: '紀錄參與人次、投入工時與資源使用。' },
  { src: '/images/esg-impact-note/result-4-employee-story.png', title: '員工回饋與影像故事', desc: '以影像與故事呈現員工真實體驗。' },
  { src: '/images/esg-impact-note/result-5-improvement.png', title: '後續改善與行動建議', desc: '提出下一次活動的改善與行動建議。' },
  { src: '/images/esg-impact-note/result-6-basic-info.png', title: '活動基本資訊與行程摘要', desc: '整理活動基本資訊與行程摘要，便於歸檔。' },
  { src: '/images/esg-impact-note/result-7-eco-action.png', title: '環境友善行動成果', desc: '彙整無痕戶外、減碳等環境友善行動。' },
  { src: '/images/esg-impact-note/result-8-employee-story2.png', title: '員工回饋與影像故事（續）', desc: '補充更多員工視角與影像紀錄。' },
];
  ...
  return (
    <div>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 -mt-8">
        <img src="/images/esg-impact-note/hero.png" alt="ESG Impact Note 頁首大橫幅" className="w-full h-64 md:h-96 object-cover rounded-2xl shadow-xl" loading="lazy" />
      </div>
