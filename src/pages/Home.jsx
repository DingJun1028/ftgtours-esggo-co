    ...
    <div>
      ...
      <section className="relative h-screen flex items-center justify-center bg-ftg-forest overflow-hidden">
        ...
        <div className="relative z-10 text-center text-white px-4 max-w-5xl mx-auto">
          ...
          <p className="text-lg md:text-2xl mb-8 text-gray-100 max-w-3xl mx-auto leading-relaxed">
            {t('home.heroSub')}
          </p>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-5 gap-6">
            {t('home.featureList').map((item, i) => (
              <div key={i} className="text-center p-6 bg-ftg-cream rounded-2xl hover:shadow-lg transition-shadow">
                <div className="w-16 h-16 bg-ftg-green/10 rounded-full flex items-center justify-center mx-auto mb-4">
      ...
      <section className="py-20 bg-ftg-sand">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
          ...
          <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-5 gap-6">
            {t('home.processList').map((item, i) => (
              <div key={i} className="text-center p-6 bg-white rounded-2xl shadow-md hover:shadow-lg transition-shadow">
                <div className="w-16 h-16 bg-ftg-green text-white rounded-full flex items-center justify-center mx-auto mb-4">
                  <span className="text-2xl">{processIcons[i]}</span>
                </div>
            ...
            {products.map((product, i) => (
              <Link key={i} to={product.link} className="group bg-ftg-cream rounded-2xl overflow-hidden hover:shadow-xl transition-all duration-300">
                <div className="relative h-48 overflow-hidden">
                  ...
                  <div className="absolute bottom-4 left-4 flex items-center justify-center w-10 h-10 bg-ftg-green text-white rounded-full font-bold text-lg">
                    {i + 1}
                  </div>
                </div>
                <div className="p-6">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-5 gap-6">
            {t('home.momentList').map((item, i) => (
              <div key={i} className="text-center p-6 bg-white rounded-2xl shadow-md hover:shadow-lg transition-shadow">
                <div className="w-16 h-16 bg-ftg-green/10 rounded-full flex items-center justify-center mx-auto mb-4">
                  <span className="text-3xl">{momentIcons[i]}</span>
                </div>
                <h3 className="font-bold text-ftg-forest mb-2">{item.title}</h3>
                <p className="text-gray-600 text-sm">{item.desc}</p>
              </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-5 gap-6">
            {t('home.stepList').map((item, i) => (
              <div key={i} className="text-center p-6 bg-ftg-cream rounded-2xl hover:shadow-lg transition-shadow">
                <div className="w-16 h-16 bg-ftg-orange text-white rounded-full flex items-center justify-center mx-auto mb-4">
                  <span className="text-2xl font-bold">{stepIcons[i]}</span>
                </div>
                <h3 className="font-bold text-ftg-forest mb-2">{item.title}</h3>
                <p className="text-gray-600 text-sm">{item.desc}</p>
              </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-5 gap-6">
            {t('home.safetyList').map((item, i) => (
              <div key={i} className="text-center p-6 bg-white rounded-2xl shadow-md hover:shadow-lg transition-shadow">
                <div className="w-16 h-16 bg-ftg-green/10 rounded-full flex items-center justify-center mx-auto mb-4">
                  <span className="text-3xl">{safetyIcons[i]}</span>
                </div>
                <h3 className="font-bold text-ftg-forest mb-2">{item.title}</h3>
                <p className="text-gray-600 text-sm">{item.desc}</p>
              </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {t('home.resultList').map((item, i) => (
              <div key={i} className="bg-ftg-cream rounded-2xl p-8 text-center hover:shadow-lg transition-shadow">
