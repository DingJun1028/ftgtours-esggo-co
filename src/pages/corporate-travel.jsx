...
const travelImages = [
  { src: '/images/corporate-travel/travel-1-team.png', title: '團隊交流', desc: '在自然與移動中，鬆開職務角色、重新交流。' },
  { src: '/images/corporate-travel/travel-2-relax.png', title: '放鬆與充電', desc: '放慢步調，讓身心真正充電。' },
  { src: '/images/corporate-travel/travel-3-nature.png', title: '自然與地方體驗', desc: '把旅遊與自然、地方文化連結起來。' },
];

const expImages = [
  { src: '/images/corporate-travel/exp-1-food.png', title: '地方餐食', desc: '結合在地食材與地方餐食體驗。' },
  { src: '/images/corporate-travel/exp-2-culture.png', title: '文化體驗', desc: '地方文化、部落或社區體驗。' },
  { src: '/images/corporate-travel/exp-3-forest.png', title: '森林慢行', desc: '低強度森林慢行，鬆動身心。' },
  { src: '/images/corporate-travel/exp-4-no-trace.png', title: '無痕戶外', desc: '落實無痕戶外，友善環境。' },
  { src: '/images/corporate-travel/exp-5-close-nature.png', title: '親近自然', desc: '引導式親近自然，打開感官。' },
  { src: '/images/corporate-travel/exp-6-light-team.png', title: '輕量團隊互動', desc: '低壓力的團隊互動設計。' },
];

const valueImages = [
  { src: '/images/corporate-travel/value-1-connect.png', title: '串接 Team Day／Wellbeing Retreat', desc: '一次規劃，延伸為系列活動。' },
  { src: '/images/corporate-travel/value-2-annual.png', title: '年度企業活動規劃', desc: '協助企業編排全年活動節奏。' },
  { src: '/images/corporate-travel/value-3-basic-summary.png', title: 'Basic Impact Summary', desc: '基礎影響力摘要，便於內部溝通。' },
  { src: '/images/corporate-travel/value-4-esg-note.png', title: 'ESG Impact Note', desc: '升級為 ESG Impact Note 成果報告。' },
];
  ...
  return (
    <div>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 -mt-8">
        <img src="/images/corporate-travel/hero.png" alt="企業員工旅遊 頁首大橫幅" className="w-full h-64 md:h-96 object-cover rounded-2xl shadow-xl" loading="lazy" />
      </div>
      ...
      <section className="py-16">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="bg-ftg-green text-white rounded-2xl p-12 text-center">
            <h3 className="text-2xl font-bold mb-4">適合对象</h3>
