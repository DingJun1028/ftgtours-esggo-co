...
const teamImages = [
  { src: '/images/esg-team-day/team-1-nature.png', title: '走進自然', desc: '讓 ESG 從報告文字變成親身參與的戶外行動。' },
  { src: '/images/esg-team-day/team-2-co-create.png', title: '團隊共創', desc: '在任務與對話中凝聚團隊共識。' },
  { src: '/images/esg-team-day/team-3-local-env.png', title: '連結地方與環境', desc: '把活動與地方共益、環境行動連結起來。' },
];

const expImages = [
  { src: '/images/esg-team-day/exp-1-eco-action.png', title: '友善環境行動', desc: '無痕山林、環境友善的實作任務。' },
  { src: '/images/esg-team-day/exp-2-team-task.png', title: '團隊合作任務', desc: '以 ESG 主題設計的團隊合作挑戰。' },
  { src: '/images/esg-team-day/exp-3-local-food.png', title: '地方餐食', desc: '結合在地食材與地方餐食體驗。' },
  { src: '/images/esg-team-day/exp-4-culture.png', title: '文化體驗', desc: '地方文化與社區體驗，深化連結。' },
  { src: '/images/esg-team-day/exp-5-forest.png', title: '森林健走', desc: '低強度森林健走，鬆動身心。' },
  { src: '/images/esg-team-day/exp-6-nature-obs.png', title: '自然觀察', desc: '引導式自然觀察，打開感官。' },
];
  ...
  return (
    <div>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 -mt-8">
        <img src="/images/esg-team-day/hero.png" alt="ESG 戶外團隊日 頁首大橫幅" className="w-full h-64 md:h-96 object-cover rounded-2xl shadow-xl" loading="lazy" />
      </div>
