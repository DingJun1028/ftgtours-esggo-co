...
const consensusImages = [
  { src: '/images/executive-retreat/consensus-1-slow-down.png', title: '放慢腳步與重新思考', desc: '脫離日常會議慣性，在自然場域重新對齊方向。' },
  { src: '/images/executive-retreat/consensus-2-nature.png', title: '連結自然與對方', desc: '在慢行與對話中，重建與彼此、與土地的連結。' },
  { src: '/images/executive-retreat/consensus-3-leadership.png', title: '領導團隊對話', desc: '以圓桌與工作坊，收斂經營團隊的共識。' },
];

const expImages = [
  { src: '/images/executive-retreat/exp-1-roundtable.png', title: '圓桌對話', desc: '引導式圓桌，讓策略對話更聚焦。' },
  { src: '/images/executive-retreat/exp-2-colearn.png', title: '團隊共學', desc: '結合趨勢與案例的共學設計。' },
  { src: '/images/executive-retreat/exp-3-local-food.png', title: '在地餐集', desc: '以地方食材與餐食體驗連結土地。' },
  { src: '/images/executive-retreat/exp-4-forest-walk.png', title: '山林慢行', desc: '低強度山林慢行，鬆動思維。' },
  { src: '/images/executive-retreat/exp-5-culture.png', title: '文化體驗', desc: '地方文化與藝術體驗，打開視野。' },
  { src: '/images/executive-retreat/exp-6-view.png', title: '靜心觀景', desc: '留白與觀景，讓反思沉澱。' },
];
  ...
  return (
    <div>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 -mt-8">
        <img src="/images/executive-retreat/hero.png" alt="高階主管共識營 頁首橫幅" className="w-full h-64 md:h-96 object-cover rounded-2xl shadow-xl" loading="lazy" />
      </div>
      ...
      <section className="py-16">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <h2 className="text-3xl font-bold text-ftg-forest mb-8 text-center">一場好的共識營，可以帶來什麼？</h2>
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 mb-16">
            {consensusImages.map((p, i) => <PhotoCard key={i} {...p} />)}
          </div>
